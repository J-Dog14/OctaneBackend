...
const PITCHING_DISPLAY_OVERRIDES: Record<string, string> = {
  ...
  "KINEMATIC_SEQUENCE|PELVIS_TIME": "Pelvis Peak Time",
  "KINEMATIC_SEQUENCE|TORSO_TIME": "Torso Peak Time",
  "KINEMATIC_SEQUENCE|ARM_TIME": "Arm Peak Time",
  "KINEMATIC_SEQUENCE|HAND_TIME": "Hand Peak Time",
